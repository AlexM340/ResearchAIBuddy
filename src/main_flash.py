...
def _default_config() -> Dict[str, Any]:
    return {
        ...
        "second_brain": {
            ...
            "graph_extraction_mode": "llm_structured",
...
def build_apci_config_dict(config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "graph_extraction_mode": sb_cfg.get("graph_extraction_mode", "llm_structured"),
        "graph_extraction_batch_size": sb_cfg.get("graph_extraction_batch_size", 5),
